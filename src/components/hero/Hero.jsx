...
const Hero = () => {
  return (
    <div className='flex sm:justify-between justify-center sm:mx-[9%] mt-[14%]  sm:mt-[6%] h-fit'>
      ...
      <div className='sm:flex hidden flex-col justify-center items-center relative '>
        <img
          className='sm:w-[412px] relative left-[2%] -top-[10px] z-50'
          src={one}
          alt='something odd was here'
        />
        <img
          className='sm:w-[412px] relative left-[14%] bottom-[500px] z-40'
          src={two}
          alt='something odd was here'
        />
        <img
          className='sm:w-[330px] relative left-[20%] bottom-[980px] z-30'
          src={thee}
          alt='something odd was here'
        />
        <img
          className='sm:w-[212px] relative  left-[23%] z-20 bottom-[1550px]'
          src={ring}
          alt='something odd was here'
        />
      </div>
